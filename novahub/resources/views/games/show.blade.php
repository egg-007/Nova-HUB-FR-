...
<div class="w-full max-w-5xl mx-auto px-4">
    ...
    <div class="bg-novaPanel rounded-xl border border-gray-800 overflow-hidden shadow-2xl flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 p-8 flex flex-col">
            ...
            <div class="mt-auto pt-6 border-t border-gray-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-4xl font-bold text-white">
                    {{ number_format($game->price, 2) }} <span class="text-2xl text-gray-500">€</span>
                </div>
                
                <button class="w-full sm:w-auto bg-novaAccent text-black px-8 py-3 rounded font-bold hover:bg-cyan-400 transition shadow-[0_0_15px_rgba(0,255,255,0.3)] flex justify-center items-center">
